        ...
        do {
            ...
            switch (pilih) {
                case 1:
                    ...
                    Mahasiswa29 mhs = new Mahasiswa29(nim, nama, kelas);
                    stack.push(mhs);
                ...
                case 2:
                    ...
                    if (dinilai != null) {
                        ...
                        String biner = stackKonversi.konversiDesimalKeBiner(nilai);
                        System.out.println("Nilai Tugas " + dinilai.nama + " dalam Biner: " + biner);
                    }
                    break;
                case 3:
                    ...
                    break;
                case 4:
                    Mahasiswa29 lihatBawah = stack.peekBottom();
                    if (lihatBawah != null) {
